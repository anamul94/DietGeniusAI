...
interface AssessmentStreamingProps {
  apiUrl?: string;
}

export default function AssessmentStreaming({ apiUrl = 'http://localhost:8000/api' }: AssessmentStreamingProps) {
  ...
  const getDisplayContent = () => {
    if (finalAssessment) {
      ...
      const fullResponse = finalAssessment.full_response || finalAssessment.summary || 'No summary available';
      
      return (
        <div className="space-y-4">
          <div className="flex justify-between items-center">
            <h3 className="text-lg font-semibold">Daily Assessment - {dateValue}</h3>
            <button
    ...
    if (chunks.length > 0 && isGenerating) {
      return (
        <div className="space-y-4">
          <h3 className="text-lg font-semibold">Generating Assessment...</h3>
          <div className="prose prose-sm max-w-none">
  ...
  return (
    <div className="space-y-6">
      <div className="bg-white shadow rounded-lg p-6">
        <div className="mb-4">
          <h2 className="text-xl font-semibold text-gray-900">Daily Assessment Streaming</h2>
